 ...
 */
export class JitsiStub implements IJitsiRoom {
  private audioCallback: ((buffer: Buffer, sampleRate: number) => void) | null = null;
 ...
 */
export function createJitsiRoom(config: JitsiConfig): IJitsiRoom {
 ...
 */
export function transformIdToEmailLike(uuid: string): string {
