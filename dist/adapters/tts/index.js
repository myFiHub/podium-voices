...
exports.AzureTTS = exports.GoogleCloudTTSADC = exports.GoogleCloudTTS = exports.StubTTS = exports.ttsToStream = void 0;
...
Object.defineProperty(exports, "GoogleCloudTTSADC", { enumerable: true, get: function () { return google_cloud_2.GoogleCloudTTSADC; } });
...
function createTTS(config) {
    ...
    if (provider === "google") {
        ...
        return new google_cloud_1.GoogleCloudTTSADC({
            voiceName: googleVoiceName,
            languageCode: "en-US",
        });
    }
