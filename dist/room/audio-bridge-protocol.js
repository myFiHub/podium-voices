...
exports.VAD_FRAME_BYTES = exports.VAD_SAMPLE_RATE = exports.BRIDGE_FRAME_BYTES = exports.BRIDGE_SAMPLES_PER_FRAME = exports.BRIDGE_FRAME_MS = exports.BRIDGE_SAMPLE_RATE = void 0;
exports.resample48kTo16k = resample48kTo16k;
exports.chunk48k20ms = chunk48k20ms;
/** Wire format: 48kHz mono 16-bit PCM. */
exports.BRIDGE_SAMPLE_RATE = 48000;
/** Frame duration in ms (stable for VAD and timing). */
exports.BRIDGE_FRAME_MS = 20;
/** Samples per frame at 48kHz: 960. */
exports.BRIDGE_SAMPLES_PER_FRAME = (exports.BRIDGE_SAMPLE_RATE * exports.BRIDGE_FRAME_MS) / 1000;
/** Bytes per frame: 960 * 2 = 1920. */
exports.BRIDGE_FRAME_BYTES = exports.BRIDGE_SAMPLES_PER_FRAME * 2;
/** VAD/ASR pipeline expects 16kHz. */
exports.VAD_SAMPLE_RATE = 16000;
/** 20ms at 16kHz = 320 samples = 640 bytes. */
exports.VAD_FRAME_BYTES = (exports.VAD_SAMPLE_RATE * exports.BRIDGE_FRAME_MS / 1000) * 2;
/**
 ...
 */
function resample48kTo16k(pcm48) {
 ...
 */
function chunk48k20ms(pcm48) {
    const frames = [];
    let offset = 0;
    while (offset + exports.BRIDGE_FRAME_BYTES <= pcm48.length) {
        frames.push(pcm48.subarray(offset, offset + exports.BRIDGE_FRAME_BYTES));
        offset += exports.BRIDGE_FRAME_BYTES;
    }
    return frames;
}
//# sourceMappingURL=audio-bridge-protocol.js.map